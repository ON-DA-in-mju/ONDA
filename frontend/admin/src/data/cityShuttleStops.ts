...
export const CITY_SHUTTLE_STOPS: RouteStopPin[] = [
  ...
  { id: "22222222-2222-2222-2222-222222222215", name: "상공회의소", lat: 37.229403, lng: 127.1878965, order: 2 },
  { id: "22222222-2222-2222-2222-222222222217", name: "진입로(럭스나인 앞)", lat: 37.2340031, lng: 127.1887195, order: 3 },
  { id: "22222222-2222-2222-2222-222222222218", name: "동부경찰서 중앙지구대", lat: 37.2348159, lng: 127.1981467, order: 4 },
  { id: "22222222-2222-2222-2222-222222222206", name: "용인CGV", lat: 37.2353177, lng: 127.205791, order: 5 },
  { id: "22222222-2222-2222-2222-222222222207", name: "중앙공영주차장", lat: 37.2340646, lng: 127.2089779, order: 6 },
  { id: "22222222-2222-2222-2222-222222222204", name: "진입로(역북동 주민센터)", lat: 37.2339842, lng: 127.1886574, order: 7 },
  { id: "22222222-2222-2222-2222-222222222216", name: "이마트", lat: 37.2313029, lng: 127.188223, order: 8 },
  { id: "22222222-2222-2222-2222-222222222220", name: "제1공학관", lat: 37.2226358, lng: 127.1869171, order: 9 },
...
export const MYONGJI_STATION_SHUTTLE_STOPS: RouteStopPin[] = [
  ...
  { id: "22222222-2222-2222-2222-222222222215", name: "상공회의소", lat: 37.229403, lng: 127.1878965, order: 2 },
  { id: "22222222-2222-2222-2222-222222222217", name: "진입로(럭스나인 앞)", lat: 37.2340031, lng: 127.1887195, order: 3 },
  { id: "22222222-2222-2222-2222-222222222205", name: "경전철 명지대역", lat: 37.2384111, lng: 127.1895676, order: 4 },
  { id: "22222222-2222-2222-2222-222222222219", name: "명지대역 사거리 정류장", lat: 37.23805, lng: 127.18965, order: 5 },
  { id: "22222222-2222-2222-2222-222222222204", name: "진입로(역북동 주민센터)", lat: 37.2339842, lng: 127.1886574, order: 6 },
  { id: "22222222-2222-2222-2222-222222222216", name: "이마트", lat: 37.2313029, lng: 127.188223, order: 7 },
...
export const CITY_SHUTTLE_VACATION_STOPS: RouteStopPin[] = [
  ...
  { id: "22222222-2222-2222-2222-222222222223", name: "정문", lat: 37.2239566, lng: 127.187995, order: 3 },
  { id: "22222222-2222-2222-2222-222222222215", name: "상공회의소", lat: 37.229403, lng: 127.1878965, order: 4 },
  { id: "22222222-2222-2222-2222-222222222217", name: "진입로(럭스나인 앞)", lat: 37.2340031, lng: 127.1887195, order: 5 },
  { id: "22222222-2222-2222-2222-222222222218", name: "동부경찰서 중앙지구대", lat: 37.2348159, lng: 127.1981467, order: 6 },
  { id: "22222222-2222-2222-2222-222222222206", name: "용인CGV", lat: 37.2353177, lng: 127.205791, order: 7 },
  { id: "22222222-2222-2222-2222-222222222207", name: "중앙공영주차장", lat: 37.2340646, lng: 127.2089779, order: 8 },
  { id: "22222222-2222-2222-2222-222222222205", name: "경전철 명지대역", lat: 37.2384111, lng: 127.1895676, order: 9 },
  { id: "22222222-2222-2222-2222-222222222204", name: "진입로(역북동 주민센터)", lat: 37.2339842, lng: 127.1886574, order: 10 },
  { id: "22222222-2222-2222-2222-222222222216", name: "이마트", lat: 37.2313029, lng: 127.188223, order: 11 },
  { id: "22222222-2222-2222-2222-222222222220", name: "제1공학관", lat: 37.2226358, lng: 127.1869171, order: 12 },
