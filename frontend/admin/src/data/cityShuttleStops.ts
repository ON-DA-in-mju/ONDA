...
export const CITY_SHUTTLE_STOPS: RouteStopPin[] = [
  { id: "22222222-2222-2222-2222-222222222202", name: "버스관리사무소", lat: 37.22482, lng: 127.18749, order: 1 },
  { id: "22222222-2222-2222-2222-222222222215", name: "상공회의소", lat: 37.22877, lng: 127.18842, order: 2 },
  { id: "22222222-2222-2222-2222-222222222217", name: "진입로(럭스나인 앞)", lat: 37.23394, lng: 127.1886, order: 3 },
  { id: "22222222-2222-2222-2222-222222222218", name: "동부경찰서 중앙지구대", lat: 37.23492, lng: 127.19855, order: 4 },
  { id: "22222222-2222-2222-2222-222222222206", name: "용인CGV", lat: 37.23509, lng: 127.20561, order: 5 },
  { id: "22222222-2222-2222-2222-222222222207", name: "중앙공영주차장", lat: 37.23421, lng: 127.20847, order: 6 },
  ...
  { id: "22222222-2222-2222-2222-222222222202", name: "버스관리사무소", lat: 37.22482, lng: 127.18749, order: 13 },
]
...
export const MYONGJI_STATION_SHUTTLE_STOPS: RouteStopPin[] = [
  ...
  { id: "22222222-2222-2222-2222-222222222202", name: "버스관리사무소", lat: 37.22482, lng: 127.18749, order: 12 },
]
...
export const CITY_SHUTTLE_VACATION_STOPS: RouteStopPin[] = [
  ...
  { id: "22222222-2222-2222-2222-222222222215", name: "상공회의소", lat: 37.22877, lng: 127.18842, order: 4 },
  { id: "22222222-2222-2222-2222-222222222217", name: "진입로(럭스나인 앞)", lat: 37.23394, lng: 127.1886, order: 5 },
  { id: "22222222-2222-2222-2222-222222222218", name: "동부경찰서 중앙지구대", lat: 37.23492, lng: 127.19855, order: 6 },
  { id: "22222222-2222-2222-2222-222222222206", name: "용인CGV", lat: 37.23509, lng: 127.20561, order: 7 },
  { id: "22222222-2222-2222-2222-222222222207", name: "중앙공영주차장", lat: 37.23421, lng: 127.20847, order: 8 },
