  ...
  return (
    <>
      <AuthLayout
        ...
        titleLine2="회원가입"
        lead="ON-DA 관리자 시스템에 오신 것을 환영합니다. 계정을 생성하여 다양한 관리자 기능을 이용해보세요."
      ...
      >
        ...
        <form className="auth-form" onSubmit={onSubmit}>
          ...
          <Field label="이메일 인증" required>
            <div className="auth-row">
              <input
                ...
                required
              />
              <button className="btn btn-outline auth-code-btn" type="button">
                인증번호 발송
              </button>
            </div>
          </Field>
          ...
          <label className="auth-check">
            ...
            />
            <span>
              <button type="button" className="auth-policy" onClick={() => setLegalOpen(true)}>
                이용약관 및 개인정보처리방침
              </button>
              에 동의합니다.
      ...
      <LegalPolicyModal open={legalOpen} onClose={() => setLegalOpen(false)} />
    </>
  )
}
